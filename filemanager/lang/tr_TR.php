...
define('lang_File_Permission_Not_Allowed', '%s İzinlerini değiştirmenize izin verilmez.'); // %s = files or folders
define('lang_File_Permission_Recursive', 'Yenilenenler Uygulansınmı?');
...
define('lang_Lang_Change', 'Dili Değiştirin');
define('lang_File_Not_Found', 'Dosya Bulunamadı.');
define('lang_File_Open_Edit_Not_Allowed', '%s Bu dosyanız için izin verilmez.'); // %s = open or edit
define('lang_Edit', 'Düzenle');
define('lang_Edit_File', "Dosyaların İçeriğini Düzenle");
...
define('lang_No_Extension','Bir dosya uzantısı eklemeniz gerekir.'); 
